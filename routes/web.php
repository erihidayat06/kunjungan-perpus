...
Route::get('/dashboard/export', [ExportController::class, 'exportExcel'])->name('exportExcel')->middleware('auth');
Route::get('/dashboard/export/excelKaryawan', [ExportController::class, 'exportKaryawanExcel'])->name('exportKaryawanExcel')->middleware('auth');
Route::get('/dashboard/export/buku-induk', [ExportController::class, 'exportBukuInduk'])->name('exportBukuInduk')->middleware('auth');
